...
class ApplicationTest : StringSpec({
    ...
    "Send til bruker skal generere PDF som først journalføres og så distribueres til bruker" {
        ...
        body.shouldContainJsonKeyValue("journalpostId", journalpostIDatabasen.journalpostId)
        body.shouldContainJsonKeyValue("bestillendeFagsystem", fagsaksystem)
    ...
    companion object {
        private fun ApplicationEnvironmentBuilder.doConfig(
            ...
            val testConfig = MapApplicationConfig(
                ...
                "dokark.distribusjon.client-url" to joarkDistribusjonUrl,
                "dokark.distribusjon.client-scope" to "dok.distribusjon.scope",
...
private val joarkDistribusjonUrl = "http://dok-distribusjon.ark.no"
...
private val mockEngine = MockEngine { request ->
    ...
    } else if (request.url.toString() == "http://dok-distribusjon.ark.no/rest/v1/distribuerjournalpost") {
        respond(
